...
public class Page<T> {
    ...
    private int pageSize = ConstantSession.PAGE_SIZE;	//每页显示的记录数，默认是10
	...
	public String toString() {
		return "Page [pageNo=" + pageNo + ", pageSize=" + pageSize + ", totalRecord=" + totalRecord + ", totalPage="
				+ totalPage + ", results=" + results + ", params=" + params + ", url=" + url + ", links=" + links + "]";
	}
	...
	public String getLinks() {
		...
		sBuf.append("	}");
		sBuf.append("</script>");
		sBuf.append("<input type=\"hidden\" id=\"page.pageNo\" name=\"pageNo\" value=\"").append(curPageNo).append("\">");		//分页参数：当前页隐藏域
