...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('userAction_insert.action','_self');this.blur();">保存</a></li>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
        	...
        	<tr>
	            ...
	            <td class="tableContent">
	            	<!-- <s:select name="userInfo.managerId" list="userList"
	            		listKey="id" listValue="userinfo.name"
	            		headerKey="" headerValue="--请选择--"
	            	></s:select> -->
	            	<select name="userInfo.managerId">
	            		<option value="-1">--请选择--</option>
